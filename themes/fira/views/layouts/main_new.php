  ...
  <ul id="navigation" class="sf-navbar">
    ...
    <li> <a href="?act=products">Product Management</a>
      ...
      <ul>
        ...
        <li><a href="supplies/create.php">Add a new Supplier</a> </li>
...
<div class="clearfix"></div>
	<div id="footer">
		...
		Copyright &copy; 2006- 2012 - <a style="color:#eee;" href="http://www.kreatech.net" target="_blank">Kreative Technologies</a>
	</div>
	</body>
</html>
