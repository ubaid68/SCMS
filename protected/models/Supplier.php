...
class Supplier extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('s_phone','numerical', 'integerOnly'=>true),
			
			//string length
			array('supplier_name', 'length', 'min'=>3, 'max'=>50),
			array('s_person', 'length', 'min'=>3, 'max'=>50),
			array('s_address', 'length', 'min'=>5, 'max'=>200),
			array('s_phone', 'length', 'min'=>7, 'max'=>20),
